...
checkmessage("a = {} bor 1", "bitwise operation")
...
checkmessage("local a = 1 shr 2.0^100", "has no integer representation")
checkmessage("local a = 10.1 shl 2.0^100", "has no integer representation")
checkmessage("local a = 2.0^100 band 1", "has no integer representation")
checkmessage("local a = 2.0^100 band 1e100", "has no integer representation")
checkmessage("local a = 2.0 bor 1e40", "has no integer representation")
checkmessage("local a = 2e100 bxor 1", "has no integer representation")
...
checkmessage("return 6e40 band 7", "has no integer representation")
checkmessage("return 34 shl 7e30", "has no integer representation")
checkmessage("return bnot -3e40", "has no integer representation")
checkmessage("return bnot -3.009", "has no integer representation")
checkmessage("return 3.009 band 1", "has no integer representation")
checkmessage("return 34 shr {}", "table value")
...
do   -- named objects (field '__name')
  ...
  checkmessage("return bnot io.stdin", "on a FILE* value")
...
checksyntax("[[a]]", "", "[[a]]", 1)
checksyntax("'aa'", "", "'aa'", 1)
checksyntax("while shl do end", "", "shl", 1)
checksyntax("for shr do end", "", "shr", 1)
