...
if string.packsize("i") == 4 then
  ...
  checkerror("too large", string.rep, 'aa', (1 shl 30))
  checkerror("too large", string.rep, 'a', (1 shl 30), ',')
end
...
do   -- assume at least 32 bits
  ...
  if max > 2.0^53 then  -- only for 64 bits
    assert(string.format("%x", (2^52 bor 0) - 1) == "fffffffffffff")
    ...
    assert(string.format("%u", bnot(-1 shl 64)) == "18446744073709551615")
